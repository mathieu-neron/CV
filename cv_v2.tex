...
\begin{cventries}
  ...
  \cventry
    ...
    {
      \begin{cvitems}
        \item {\textit{Java, TypeScript, GraphQL, GCP, Temporal, Elasticsearch, Python, ANTLR}}
        ...
        \item {Shipped rule removal and archival for the fraud-risk platform, unblocking the operational risk team from a backlog of stale rules.}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {2026}
    {
      \begin{cvitems}
        ...
        \item {Privacy-engineered hash-prefix lookup (5000$\times$ SHA256); contract-tested API, e2e tests, 10 architecture design docs.}
      \end{cvitems}
    }
...
\begin{cvskills}
  ...
  \cvskill
    {Platforms}
    {GCP, AWS, PostgreSQL, Elasticsearch, Redis, Oracle, MySQL, Docker}
  \cvskill
    {Spoken}

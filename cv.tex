...
\begin{itemize}
	...
	\item \textbf{Established} new blocking mechanisms on fraudulent account holders, by preventing them from performing certain specific actions (perform card transactions, creation accounts, etc.). Collaborated with the txn team for feature discussion and development.
\end{itemize}
}
